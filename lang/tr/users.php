...
return array(
  ...
  'invite' => array(
    ...
    'email'   => 'Eposta adresleri (ayrı satırlar)',
    'message' => 'Mesajınız (isteğe bağlı)',
    'sample'  => 'I would like to invite you to join this Learning Record Store (LRS).',
    'invited' => 'Bu kullanıcılar davet edilmiştir.',
    'failed'  => 'Bu kullanıcıyı davet etme işlemi başarısız oldu, kullanıcının halihazırda LRS\'in üyesi olup olmadığını ve eposta adresinin geçerliliğini kontrol ediniz.',
