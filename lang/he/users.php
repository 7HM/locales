...
return array(
  ...
  'invite' => array(
    'invite'  => 'הזמן משתמשים',
    'email'   => 'כתובות דוא"ל (אחת בכל שורה)',
    'message' => 'הודעה (אופציונלי)',
    'sample'  => 'אני רוצה להזמין אותך להצטרף ל- LRS (מאגר תיעוד למידה) הזה.',
    'invited' => 'המשתמשים הבאים הוזמנו.',
    'failed'  => 'הזמנת משתמש זה נכשלה, אנא בדקו שהמשתמש אינו רשום כבר ל- LRS ושכתובת הדוא"ל תקינה.'
  ),
  'password'         => 'Password',
