...
return array(
  ...
  'invite' => array(
    ...
    'email'   => 'Endereço de email (separar linhas)',
    'message' => 'Mensagem (opcional)',
    'sample'  => 'Eu gostaria de convidar você para usar este LRS',
    'invited' => 'Aqueles usuários foram convidados',
    'failed'  => 'O convite a este usuário falhou. Verifique se o usuário já não é membro do LRS e se o email é válido.'
  ),
  'password'         => 'Password',
